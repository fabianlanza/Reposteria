...
Public Class NuevoEmpleado
    ...
    Private Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        ...
        If (txtNombre.Text = String.Empty Or txtEmail.Text = String.Empty Or txtTelefono.Text = String.Empty) Then
            MessageBox.Show("Los espacios no pueden estar en blanco")
        Else
            Dim dataTable As DataTable = DirectCast(dgvEmpleado.DataSource, DataTable)
